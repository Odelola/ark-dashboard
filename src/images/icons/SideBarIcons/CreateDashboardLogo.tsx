...
const CreateDashbooardLogo: FC = () => {
    return (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_117_24)">
                ...
                <path d="M10.4166 5.83337H9.16663V10.8334L13.5416 13.4584L14.1666 12.4334L10.4166 10.2084V5.83337Z" fill="white" />
            </g>
            <defs>
...
export default CreateDashbooardLogo;